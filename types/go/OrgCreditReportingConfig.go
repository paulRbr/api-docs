type OrgCreditReportingConfig struct {
	...
	TransunionProgramIdentifier *string `json:"transunion_program_identifier,omitempty"`// If included, a metro2 report will be generated for your organization which uses this code; to report to TransUnion.
}
