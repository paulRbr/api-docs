type ComplexAccount struct {
	AccountID                        int64                             `json:"account_id"`                                    // This is generated by Canopy. A unique ID for the account.
	...
	Customers                        []Customer                        `json:"customers"`                                     // An array of customers who have been assigned to the account
}
