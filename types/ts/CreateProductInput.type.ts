...
export interface PostPromotionalPolicies {
     ...
     */
    post_promo_min_pay_type?: PostPromoMinPayType;
}

/**
 * Current due calculation method for the post-promotional period.
 */
export type PostPromoMinPayType = 
    "AM";
...
export interface DefaultAttributes {
    /**
     * The default maximum principal credit (in cents) available for a customer account. For
     * risk-based-pricing, this default limit can be overridden on a per-account basis if a
     * `credit_limit` is selected at the time of assigning an account to a product in the
     * `Create Account` call. Credit limits for an account can also be updated post-account
     * creation.
     */
    default_credit_limit_cents: number;
    /**
     * The default late fee for accounts enrolled in this product. This will be used if no late
     * fee is provided at account creation.
     */
    default_late_fee_cents?: number;
    /**
     * The default payment reversa fee for accounts enrolled in this product. This will be used
     * if no late fee is provided at account creation.
     */
